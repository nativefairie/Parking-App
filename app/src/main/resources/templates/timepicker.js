 ...
 * plugin: timepicker
 * website: senthilraj.github.io/Timepicker
 */
(function($) {
		...
		return this.each(function() {
			...
			var new_ele = $(
				"<div class='timepicker_wrap " + settings.custom_classes + "'>" +
					...
					"<div class='time'>" +
						top_arrow_button +
						"<div class='ti_tx'><input type='text' class='timepicker-input'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "></div>" +
						bottom_arrow_button +
					"</div>" +
					"<div class='mins'>" +
						top_arrow_button +
						"<div class='mi_tx'><input type='text' class='timepicker-input'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "></div>" +
						bottom_arrow_button +
					"</div>");
			if(settings.show_meridian){
				new_ele.append(
					"<div class='meridian'>" +
						top_arrow_button +
						"<div class='mer_tx'><input type='text' class='timepicker-input' readonly></div>" +
						bottom_arrow_button +
					"</div>");
			}
			if(settings.reset){
			...
			$(".timepicker-input").keydown(function (keyevent) {
			    ...
			    // timepicker inputs are valid, and that pressing
			    // enter does not submit the form if the
			    // input field on which timepicker is applied is a part of a form.
